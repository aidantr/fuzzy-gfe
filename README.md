...
The bash file `runall.sh` runs all the necessary Matlab files to reproduce the tables and figures in the main text and appendix. If you're interested in implementing the FCR estimator on your own dataset, check out the `FCR.m` function in the code/functions folder.
